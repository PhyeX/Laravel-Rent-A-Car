                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action = "{{route('admin_car_update',['id'=>$data->id])}}" method="post" enctype="multipart/form-data">
                            ...
                            <label>Slug</label>
                            <input type="text" name="slug"  value="{{ $rs -> slug }}"class="form-control" id="inputEmail4">
                            <br>

                            <label>Description</label>
                            <input type="text" name="description" value="{{ $data  -> description }}" class="form-control" id="inputEmail4">
                            <br>
                            ...
                            <label>Age</label>
                            <input type="number" name="age" value="{{ $data  -> age }}" class="form-control" id="inputEmail4">
                            <br>

                            <label>Doors</label>
                            <input type="number" name="door" value="{{ $data  -> doors }}"  class="form-control" id="inputEmail4">
                            <br>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name ="transmission" id="exampleFormControlSelect1">
                                    <option selected="selected" >{{ $data -> transmission }}</option>
                            ...
                            <button style=" margin: auto ; text-align: center; " type="submit" class="btn  btn-primary">Update Car</button>
